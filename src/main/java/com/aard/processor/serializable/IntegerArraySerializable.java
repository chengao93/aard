 ...
 */
public class IntegerArraySerializable {
    /**
     * 类型名称
     */
     ...
     */
    public static byte[] serializable(Integer[] value) {
     ...
     * @date 2021/11/6 9:11
     */
    public static int valueByteLength(Integer[] value) {
        if (value == null) {
            return 1;
        }
        int len = 5;
        for (Integer val : value) {
            len += IntegerSerializable.valueByteLength(val);
        }
        return len;
    }
     ...
     * @date 2021/10/20 18:35
     */
    public static byte[] serializableValue(Integer[] value) {
        if (value == null) {
            return new byte[]{0};
        }
        ...
        int index = 5;
        for (Integer val : value) {
            index = IntegerSerializable.serializableValue(bytes, index, val);
        }
        return bytes;
    }
     ...
     * @date 2021/10/20 18:35
     */
    public static void serializableValue(Integer[] value, ByteBuf buffer) {
        if (value == null) {
            buffer.writeByte(0);
            return;
        }
     ...
     * @date 2021/10/20 18:35
     */
    public static int serializableValue(byte[] bytes, int index, Integer[] value) {
        if (value == null) {
     ...
     * @date 2021/10/20 18:35
     */
    public static Integer[] deserialization(ByteBuffer byteBuffer) {
        int len = byteBuffer.getInt();
        Integer[] arr = new Integer[len];
        for (int i = 0; i < len; i++) {
            arr[i] = IntegerSerializable.deserializationValue(byteBuffer);
        }
        return arr;
    }
     ...
     * @date 2021/10/20 18:35
     */
    public static Integer[] deserializationValue(ByteBuffer byteBuffer) {
