 ...
 */
public class IntArraySerializable {
    /**
     * 类型名称
     */
    public static final String CLASS_NAME_ = int[].class.getName();
    /**
     * 类型名称
     */
    public static final String CLASS_NAME = CLASS_NAME_;
    ...
    public static byte[] serializableValue(int[] value) {
        ...
        int index = 5;
        for (int val : value) {
            index = IntSerializable.serializableValue(bytes, index, val);
        }
        return bytes;
    }
