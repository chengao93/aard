 ...
 */
public class BooleanArraySerializable {
    /**
     * 类型名称
     */
    ...
    public static int valueByteLength(Boolean[] value) {
        ...
        for (Boolean val : value) {
            len += BooleanSerializable.valueByteLength(val);
        }
        return len;
    }
    ...
    public static byte[] serializableValue(Boolean[] value) {
        ...
        int index = 5;
        for (Boolean val : value) {
            index = BooleanSerializable.serializableValue(bytes, index, val);
        }
        return bytes;
    }
    ...
    public static Boolean[] deserialization(ByteBuffer byteBuffer) {
        ...
        for (int i = 0; i < len; i++) {
            arr[i] = BooleanSerializable.deserializationValue(byteBuffer);
        }
        return arr;
    }
